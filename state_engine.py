...
_INTENT_PATTERNS: dict[str, list[str]] = {
    ...
    'analysis_upload': [
        ...
        # micro-patch T27: added 'гистологии' (genitive of гистология)
        'гистологию', 'гистологии', 'гистологического', 'онкологию', 'метастазы',
    ...
    'fear': [
        ...
        # micro-patch T38: added worsening signals → fear intent
        'хуже', 'стало хуже', 'ухудшение', 'становится хуже', 'ухудшилось',
    ],
    'doubt': [
    ...
    'support': [
        ...
        'есть обновление', 'есть новость',
        # BUG-L3-4 FIX: removed bare 'результаты' — too generic, hijacks
        # 'результаты гистологии', 'результаты МРТ' (analysis_upload context).
        # Replaced with context-specific support phrases only.
        'результаты лечения', 'мои результаты', 'результаты сессии',
        'улучшение',
