...
FAST_PATH_RESPONSES: Dict[FastPathIntent, str] = {
    ...
    FastPathIntent.GREETING:
        "Привет. Вы в Python Method Center — здесь работает живой эксперт Карен, который сопровождает каждого индивидуально. "
        "Расскажите, с чем пришли — или просто напишите, что сейчас происходит.",

    FastPathIntent.PRICE_QUESTION:
        "Два фиксированных формата: «Знакомство» — $1113 / 6 недель, «Полное сопровождение» — $4725 / 6 месяцев. "
        "Цена одинакова для всех — не зависит от ситуации. Какой формат ближе?",
    ...
    FastPathIntent.WHAT_NEXT:
        "Сейчас сориентирую вас. Расскажите коротко — что последнее произошло или что сейчас непонятно?",
    ...
    FastPathIntent.POST_PAYMENT_ACK:
        "Оплата получена. Вы внутри маршрута сопровождения — это не покупка, это начало пути. "
        "Сейчас подготовим следующий шаг вместе.",

    FastPathIntent.FAQ_DURATION:
        "Два формата сопровождения: 6 недель («Знакомство») или 6 месяцев («Полное сопровождение»). "
        "Первый можно продлевать неограниченно. Хотите разобраться, какой подходит вам?",

    FastPathIntent.FAQ_FORMAT:
        "AI-центр помогает сориентироваться в формате участия и передать вопрос дальше. "
        "Хотите узнать, как устроено участие?",

    FastPathIntent.FAQ_GUARANTEE:
        "По вопросам ожиданий и результатов — это обсуждается напрямую с Кареном. Хотите, я передам ваш вопрос?",
